...
public class SolicitudAnulacionDto
{
    ...
    // Nota de Crédito emitida a SUNAT al aprobar (solo Boleta/Factura)
    public string? NotaCreditoNumeroFormateado { get; set; }
    public string? NotaCreditoEstado           { get; set; }
}
